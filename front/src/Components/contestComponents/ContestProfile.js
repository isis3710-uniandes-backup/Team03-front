                    ...
                    <div className="collapsible-body">
                      ...
                      <div className = "row">                      
                        <div className = "col s6">
                          <audio controls>
                            <source src={"./supervoicesfiles/finalvoices/"+participation.participation_route} type="audio/mp3"/>
                            Your browser does not support the audio element.
                          </audio>
                        </div>
                        <div className = "col s6">
                          <p>Puedes descargar el <a href={"./supervoicesfiles/voices/"+ participation.participation_originalroute} download>archivo original</a>.</p>
                        </div>
                      </div>
                    </div>
                </li>            
        ...
        <div className = "container">  
            <center>
              ...
              <div className ="carousel carousel-slider">
                  <a className ="carousel-item" href="#one!"><img className = "responsive-img" src={"./supervoicesfiles/images/"+this.state.contest.contest_banner}/></a>
              </div>
              <br></br>
